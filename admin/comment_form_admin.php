...
class Comment_Form_Admin extends Comment_Form_Main {
    ...
    public function register_settings() {
        ...
        // add settings fields
        add_settings_field('cf_setting_display_url', __('remove url field', 'commentform'), array($this, 'render_hide_url_field_callback'), 'comment-form-customizer', 'comment_form_url_section');

        // register setting for $_POST handling
        register_setting('comment_form_url_section', 'cf_setting_display_url');
    }
    ...
    public function render_hide_url_field_callback() {
        echo '<input name="cf_setting_display_url" id="cf_setting_display_url" type="checkbox" value="1" class="code" ' . checked(1, get_option('cf_setting_display_url'), false) . ' />';
